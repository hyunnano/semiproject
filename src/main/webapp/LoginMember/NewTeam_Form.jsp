...
<!-- <br>
          <input type="checkbox" name="t_age" id="age" value="10"><span>10대</span>  
          <input type="checkbox" name="t_age" id="age" value="20"><span>20대</span> 
          <input type="checkbox" name="t_age" id="age" value="30"><span>30대</span> 
          <input type="checkbox" name="t_age" id="age" value="40"><span>40대</span> 
          <input type="checkbox" name="t_age" id="age" value="50"><span>50대</span> 
          <input type="checkbox" name="t_age" id="age" value="60"><span>60대</span> 
          <input type="checkbox" name="t_age" id="age" value="70"><span>70대</span> 
        -->